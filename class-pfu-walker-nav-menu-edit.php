<?php  
	...
	class PFU_Walker_Nav_Menu_Edit extends Walker_Nav_Menu {
	/**
		...
		<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<?php  
					...
					$cbs = '';
					$user_groups = get_post_meta( $item_id, 'user_group');
					foreach ($tmp as $key => $ug) {
						$checked = '';
						if(in_array($ug->id, $user_groups)) {$checked='checked';}
						$cbs .= '<input type="checkbox" name="user_group_'.$item_id.'[]"  value="'.$ug->id.'" '.$checked.'>'.$ug->name.'&nbsp;';
					}
					$op .= '<table class="form-table"><tr><td>
					'.$cbs.'</td></tr></table>';
				?>
				<p class="description description-thin">
					<label for="edit-menu-item-user-group-<?php echo $item_id; ?>">
						用户分组<br />
						<?php echo $op; ?>
					</label>
				</p>
